...
import BrandingSvg from "../../Component/SvgComponents/BrandingSvg";
import MobileApp from "../../Component/SvgComponents/MobileApp";
import PrintMedia from "../../Component/SvgComponents/PrintMedia";
import DigitalMarketing from "../../Component/SvgComponents/DigitalMarketing";
import ECommerce from "../../Component/SvgComponents/ECommerce";
...
function ContactUsForm() {
  ...
  return (
   ...
   onSubmit={(values, {resetForm}) => {
    ...
    >
      {(formik) => (
        <section id="formikContainer" className="bg-colorLightPink" >
        
          <div className="mx-2 mx-md-5 pl-4 pl-md-2">
            <div className="card contactUs-main border-0 formikContainerMain mx-lg-5">
